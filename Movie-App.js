...
$("tbody").on("click", ".btn.btn-danger", function(evt) { //why is btn.btn has a dot in bettwee?
...
function createMovieDataHTML(data) { //meed some explanation on data-delete-id
    return `
      <tr>
        <td>${data.title}</td>
        <td>${data.rating}</td>
